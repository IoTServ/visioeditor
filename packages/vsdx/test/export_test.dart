...
void main() {
  ...
  test('all Visio arrow ids survive write, reopen and SVG export', () {
    ...
    expect(
      sourceSvg,
      contains('d="M 0 1 L 10 5 L 0 9 Q 7 5 0 1 Z" fill="#'),
      reason: 'native marker 6 keeps the filled convex quadratic',
    );
    expect(
      sourceSvg,
    ...
    expect(
      sourceSvg,
      contains('d="M 0 2.5 L 10 5 L 0 7.5 Z" fill="none"'),
      reason: 'native marker 15 keeps the open narrow triangle',
    );
    expect(
      sourceSvg,
      contains('d="M 0 0.5 L 10 5 L 0 9.5 L 2.5 5 Z" fill="none"'),
      reason: 'native marker 18 keeps the open swept head',
    );
    expect(
      sourceSvg,
    ...
    expect(
      svg,
      isNot(contains('d="M 0 2.5 L 10 5 L 0 7.5 Z" fill="#')),
      reason: 'id 2 bakes the filled narrow triangle as Geometry for LibreOffice',
    );
    expect(
      svg,
      isNot(contains('d="M 0 2.5 L 10 5 L 0 7.5 Z" fill="none"')),
      reason: 'id 15 bakes the open narrow triangle as Geometry for LibreOffice',
    );
    expect(
      svg,
