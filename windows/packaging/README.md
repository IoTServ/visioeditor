...
| store | true |
| file_extension | .vsdx, .vsdm, .vstx, .vstm, .vssx, .vssm, .vsd, .vss, .vst, .vdx, .vsx, .vtx |
...
`VisioEditor.Drawing` and legacy `.vsd/.vss/.vst/.vdx/.vsx/.vtx` under `VisioEditor.Drawing.Binary`
